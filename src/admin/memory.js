...
async function renderMemoryPage(db, message, error) {
  ...
  const content = `
    ...
    ${pageHeader("Memory", {
      description: "Three-layer memory: short-term conversation context, profile facts, and long-term memory. Facts here are normally learned automatically by Ava during conversations; manual edits are for corrections only.",
    })}
  ...
  return new Response(layout({
    title: "Memory",
    currentPage: "/admin/ava_brain/memory",
    content,
    session: true,
